...
export class Scene_To_Texture_Demo extends Scene {
    ...
    constructor() {
        ...
        this.materials = {
            a: new Material(bump, {ambient: .8, diffusivity: .3, specularity: .3, texture: new Texture("assets/grid.png")}),
            b: new Material(bump, {ambient: .8, diffusivity: .3, specularity: .3, texture: new Texture("assets/primaries.png")}),
